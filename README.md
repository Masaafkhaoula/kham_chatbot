...
kham_chatbot is a sleek AI-powered chatbot app built using **Flutter** and **OpenAI GPT-4o/DALL·E APIs**. It lets users:
...
1. Clone the repo:
   ```bash
   git clone https://github.com/kham/kham_chatbot
   cd kham_chatbot
   ```
